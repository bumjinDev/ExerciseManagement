...
public class ImproveEquivalenceCheck {
    ...
    private static Verdict runCase(TeamFormationEngine engine, String label,
        ...
        // [비활성 2026-08-14] 엔진의 _backup 넷 제거로 옛판 대조를 주석 처리. 원본 엔진은 docs/병목개선/ForkJoinPool/기타/코드백업 참조.
        ...
        */
        ...
        // [비활성 2026-08-14] worst = worse(worst, compare(engine, label + " 대조2 옛 순차 대 새 순차", oldSeqTeams, seqTeams));
